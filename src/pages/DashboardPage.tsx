...
export function DashboardPage() {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      ...
      setLog(prev => {
        const events = [
          'Render pass started', 'Layout computed', 'GPU flush', 'Event polled',
          'State reconciled', 'Paint scheduled', 'Frame submitted', 'Texture uploaded',
          'Shader compiled', 'Buffer mapped', 'Glyph rasterized', 'Path stroked',
        ];
  ...
  return (
    <view display="flex" flexDir="col" gap={0} h="full" scrollable>
      <view
        display="flex" flexDir="row" items="center" justify="between"
        px={24} py={16}
      ...
      <view display="flex" flexDir="col" gap={20} p={24}>
        ...
        <view display="flex" flexDir="row" gap={12}>
          ...
          >
            <text fontSize={14} fontWeight={700} color={C.text}>Resource Usage</text>
            <ProgressBar
              label="CPU"
              value={cpu}
          ...
          >
            ...
            <view display="flex" flexDir="col" gap={8}>
              ...
              <view display="flex" flexDir="row" items="center" justify="between">
                ...
                <text fontSize={13} fontWeight={700} color={C.textSub}>51.2%</text>
              </view>
            </view>
          </view>
        </view>
