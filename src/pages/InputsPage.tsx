    ...
    <view display="flex" flexDir="col" gap={0} h="full" scrollable>
      ...
      <view display="flex" flexDir="col" gap={20} p={24}>
        <view display="flex" flexDir="col" gap={8}>
          <text fontSize={13} fontWeight={600} color={C.textSub}>Search Field</text>
          <input
            value={search}
        ...
        <view display="flex" flexDir="row" gap={16}>
          <view display="flex" flexDir="col" gap={8} flex={1}>
            <text fontSize={13} fontWeight={600} color={C.textSub}>Username</text>
            <input
              value={username}
          ...
          <view display="flex" flexDir="col" gap={8} flex={1}>
            <text fontSize={13} fontWeight={600} color={C.textSub}>Email</text>
            <input
              value={email}
        ...
        <view display="flex" flexDir="row" gap={16}>
          <view display="flex" flexDir="col" gap={8} flex={1}>
            <text fontSize={13} fontWeight={600} color={C.textSub}>Password (secure)</text>
            <input
              secure
              value={password}
          ...
          <view display="flex" flexDir="col" gap={8} flex={1}>
            <text fontSize={13} fontWeight={600} color={C.textSub}>Confirm Password</text>
            <input
              secure
              value={confirm}
        ...
        <view display="flex" flexDir="row" gap={8}>
          ...
          <button
            ...
            cursor="pointer"
          >
            <text fontSize={14} color={C.textMuted}>Reset</text>
          </button>
        </view>
